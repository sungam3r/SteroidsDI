...
{
    /// <summary>
    /// Options to customize the behavior of <see cref="IServiceProvider" /> when used in Func / Defer / Factory.
    /// </summary>
    public sealed class ServiceProviderAdvancedOptions
    {
        /// <summary>
        /// <see langword="true"/> to validate the situation with the presence of parallel scopes from different providers. The situation is unlikely.
        /// </summary>
