...
internal class UseFriendlyObjectDisposedExceptionTests
{
    ...
    public void ObjectDisposedException_UseFriendlyObjectDisposedException_Enabled()
    {
        ...
        var t = Task.Run(() =>
        {
            ...
            ex.Message.ShouldBe(@"ObjectDisposedException occurred while resolving service 'ScopedService' by scoped service provider obtained from 'SteroidsDI.GenericScopeProvider`1[[SteroidsDI.Tests.Cases.UseFriendlyObjectDisposedExceptionTests, SteroidsDI.Tests, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null]]'.
